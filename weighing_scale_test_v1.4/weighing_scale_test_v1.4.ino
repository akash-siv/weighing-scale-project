...
float calibration_factor = 678;
float units;
//float ounces;

String inputString;
String calString;
long inputInt = 370; // initial value set to 500 grams
bool lop = true;
bool lop2 = true;
...
//  value in float
  int round_down = units;
  Serial.print(round_down);
...
void cal_pad(){
  ...
  int adc_val3;
  adc_val3 = analogRead(A7); /* Read input from keypad */
  if (adc_val3>850)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("D");
  ...
  else if ( adc_val3>450  && adc_val3<510)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("C");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>300  && adc_val3<350)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("B");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>230  && adc_val3<270)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("A");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>160  && adc_val3<180)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("STOP");
    Serial.print(adc_val3);
    calString = ""; // clear the input
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print("CALIBRATION");
    delay(100);
  }
  else if ( adc_val3>145  && adc_val3<155)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("9");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>125  && adc_val3<135)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("6");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>105  && adc_val3<120)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("3");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>92  && adc_val3<99)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("0");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>85  && adc_val3<90)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("8");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>77  && adc_val3<81)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("5");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>72  && adc_val3<76)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("2");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>65  && adc_val3<68)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("START");
    Serial.print(adc_val3);
    if (calString.length() > 0) {
        calibration_factor = calString.toInt(); // YOU GOT AN INTEGER NUMBER
        Serial.print(calibration_factor);
        calString = "";               // clear input
        lop2 = false;                 // break the loop
        lcd.clear();
        lcd.setCursor(0, 0);
...
//        lcd.setCursor(9, 1);
  ...
  else if ( adc_val3>60  && adc_val3<62)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("7");
    Serial.print(adc_val3);
  ...
  else if ( adc_val3>57  && adc_val3<59)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("4");
    Serial.print(adc_val3);
  ...
  else if( adc_val3>52  && adc_val3<56)
  {
    Serial.print("Key Pressed from loop : ");
    Serial.println("1");
    Serial.print(adc_val3);
